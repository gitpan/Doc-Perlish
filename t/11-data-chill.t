...
use Doc::Perlish::EventBuffer;

BEGIN { use_ok("Doc::Perlish::Data::Chill"); }
...
my $eb = Doc::Perlish::EventBuffer->new;
...
isa_ok($chiller, "Doc::Perlish::Data::Chill", "new P::D::Chill");
